...
food_rect = Rect(side_bar_w/2, food_rect_x, food_rect_w, food_rect_w, 0, food_rect_color)
...
food_rect_shadow = Rect(side_bar_w/2,food_rect_x, food_rect_w, food_rect_w, 1, BLACK)
...
def detect_mouse_actions():
		...
		if food_rect.drop ==True:
			food_rect.color = food_rect_drop_color
